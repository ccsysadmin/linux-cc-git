...
options=('!strip')
source=("https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git/snapshot/${_srcname}.tar.gz"
...
sha256sums=('2ea764a88d8e58b60fe2dfe0bae7847ae66d9a3061155513691f1a9291702ac8'
